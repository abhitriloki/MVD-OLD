...
const VehicleDetails = (props) => {
    ...
    const check_validate = async () => {
        if (props.vehicle_brand == "" || props.vehicle_color == "" ||
            ...
            dropDownAlertRef.alertWithType('error', strings.validation_error, strings.please_enter_all_the_required_fields);
        } else {
            call_vehicle_update();
        }
    }
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <ScrollView>
                <View style={{ alignItems: 'center' }}>
                    <Text style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>{strings.add_your_vahan}</Text>
                    <View style={{ margin: 20 }} />
                    <View style={{ width: '90%' }}>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vahan_name}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleName')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholder={strings.vahan_name}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vahan_brand}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleBrand')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholderTextColor={colors.grey}
                                        style={styles.textinput}
                                        placeholder={strings.vahan_brand}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vahan_color}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleColor')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholderTextColor={colors.grey}
                                        style={styles.textinput}
                                        placeholder={strings.vahan_color}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vahan_number}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleNumber')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholderTextColor={colors.grey}
                                        style={styles.textinput}
                                        placeholder={strings.vahan_number}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vahan_type}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateVehicleType')} style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        ...
                                        placeholderTextColor={colors.grey}
                                        style={styles.textinput}
                                        placeholder={strings.vahan_type}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View>
                        {/* <View style={{ marginBottom: 20 }}>
                            <Text style={{ color: colors.text_grey, fontSize: f_xs, fontFamily: bold }}>{strings.vahan_amenities}</Text>
                            <View style={{ margin: 5 }} />
                            <TouchableOpacity activeOpacity={1} onPress={navigate.bind(this, 'CreateAmenities')} style={{ flexDirection: 'row' }}>
                                <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_bg_three }}>
                                    <Icon type={Icons.MaterialIcons} name="local-hospital" color={colors.theme_fg_two} style={{ fontSize: 30 }} />
                                </View>
                                <View style={{ width: '85%', alignItems: 'flex-start', paddingLeft: 10, justifyContent: 'center', backgroundColor: colors.text_container_bg }}>
                                    <TextInput
                                        editable={false}
                                        ...
                                        placeholderTextColor={colors.grey}
                                        style={styles.textinput}
                                        placeholder={strings.add_your_amenities}
                                    />
                                </View>
                            </TouchableOpacity>
                        </View> */}
