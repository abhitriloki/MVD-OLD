...
import { updateAadharNumber } from '../actions/RegisterActions';
...
const CreateEmail = (props) => {
    ...
    const navigate = async () => {
        props.updateAadharNumber(aadhar_number);
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={2} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold, textAlign:'center' }}>{strings.enter_your_aadhar_Card_number}</Text>
                <View style={{ margin: 5 }} />
