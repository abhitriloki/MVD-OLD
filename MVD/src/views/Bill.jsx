                ...
                <ScrollView>
                    <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_bg, padding: 20, flexDirection:'row' }}>
                        ...
                        <View style={{ width: '90%', alignItems: 'center', justifyContent: 'center' }}>
                            <Text numberOfLines={1} style={{ color: colors.theme_fg_three, fontSize: f_25, fontFamily: regular }}><Text style={{ fontFamily: bold }}>{app_name}</Text> {strings.receipt}</Text>
                        </View>
                    </View>
                    <View style={{ padding: 20 }}>
                        <View style={{ width: '100%' }}>
                            <Text style={{ letterSpacing: 1.5, lineHeight: 40, color: colors.theme_fg_two, fontSize: f_25, fontFamily: regular, textAlign: 'center' }}>{strings.dear} <Text style={{ fontFamily: bold }}>{data.driver.first_name}</Text>, {strings.thanks_for_using} {app_name}</Text>
                        </View>
                        <View style={{ margin: 20 }} />
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                <View style={{ flexDirection: 'row' }}>
                                    <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_25, fontFamily: bold }}>{strings.total}</Text>
                                    <View style={{ margin: 5 }} />
                        ...
                        <View style={{ margin: 5 }} />
                        {data.collection_amount != 0 &&
                            <View style={{ flexDirection: 'row' }}>
                                <View style={{ width: '50%', alignItems: 'flex-start', justifyContent: 'center' }}>
                                    <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>{strings.ride_price}</Text>
                                </View>
                                <View style={{ width: '50%', alignItems: 'flex-end', justifyContent: 'center' }}>
                    ...
                    <View style={{ padding: 20 }}>
                        <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: normal }}>{strings.booking_details}</Text>
                        <View style={{ margin: 5 }} />
                        <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: regular }}>{data.trip_type_name} - {data.vehicle_type} | {data.distance} {strings.km}</Text>
                        <View>
            ...
            {data.customer_rating == 0 && from != 'trips' &&
                <View style={{ position: 'absolute', bottom: 0, width: '100%', height: 100, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                    <TouchableOpacity onPress={handle_back_button_click.bind(this)} activeOpacity={1} style={{ width: '45%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontFamily: bold }}>{strings.home}</Text>
                    </TouchableOpacity>
                    <View style={{ width: '3%' }} />
                    <TouchableOpacity onPress={navigate_rating.bind(this, data)} activeOpacity={1} style={{ width: '45%', backgroundColor: colors.btn_color, borderRadius: 10, height: 50, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ color: colors.theme_fg_two, fontSize: f_m, color: colors.theme_fg_three, fontFamily: bold }}>{strings.write_review}</Text>
                    </TouchableOpacity>
                </View>
            }
            {data.customer_rating == 0 && from == 'trips' &&
