...
const EditAccountNumber = (props) => {
    ...
    const check_valid = () => {
        if (account_number) {
            ...
            dropDownAlertRef.alertWithType('error', strings.validation_error, strings.please_enter_your_account_number);
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            .then(async response => {
                setLoading(false);
                dropDownAlertRef.alertWithType('success', strings.successfully_updated, strings.your_account_number_has_been_updated);
                go_back();
            })
            .catch(error => {
                setLoading(false);
