      ...
      {loading == false ?
        <View>
          <View style={styles.header} >
            <Text style={{ color: colors.theme_fg_three, fontFamily: bold, fontSize: f_l }}>{strings.hi_new_booking_arrived}</Text>
          </View>
          ...
          <TouchableOpacity activeOpacity={1} onPress={call_accept.bind(this)} style={styles.footer} >
            <Text style={{ color: colors.theme_fg_three, fontFamily: bold, fontSize: f_xl }}>{strings.start_ride}</Text>
          </TouchableOpacity>
        </View>
        :
