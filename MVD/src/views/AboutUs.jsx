    ...
    return (
        <SafeAreaView style={styles.container}>
          ...
          <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
            <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{strings.about_us}</Text>
          </View>
        </View>
            <ScrollView>
                    ...
                    <View>
                        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Text style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: regular }}>
                                {strings.version} {data.app_version}
                            </Text>
                        </View>
                        <View style={{ margin: 10 }} />
                        <View style={{ backgroundColor: colors.theme_bg_three, padding: 10, margin: 10, borderRadius: 10 }}>
                            <View style={{ margin: 10 }}>
                                <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_two, fontSize: f_l, fontFamily: bold }}>{strings.who_we_are}</Text>
                                <View style={{ margin: 5 }} />
