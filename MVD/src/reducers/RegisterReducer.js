...
const RegisterReducer = (state = { phone_number:undefined, phone_with_code:undefined, country_code:undefined, first_name:undefined, last_name:undefined, aadhar_number:undefined, licence_number:undefined, date_of_birth:undefined }, action) => {
    switch (action.type) {
        ...
        case Actions.UPDATE_AADHAR_NUMBER:
            return Object.assign({}, state, {
                aadhar_number: action.data
            });
