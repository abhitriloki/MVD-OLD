...
export const app_name = "Mamta Vahan";
export const base_url = "https://www.mamtavahanjharkhand.in/";
export const api_url = "https://www.mamtavahanjharkhand.in/api/";
export const img_url = "https://www.mamtavahanjharkhand.in/public/uploads/";
...
export const get_government_messages = "customer/get_government_messages";
export const get_checklist = prefix+"get_checklist";
export const checklist_update = prefix+"checklist_update"; 
...
//Map 
export const GOOGLE_KEY = "AIzaSyCl1NQher-pBh1T4wh-4Ot9zaCzmKdW9Mk";
...
export const passbook_icon = require('.././assets/img/passbook_icon.png');
...
export const government = require(".././assets/img/government.png");
export const jharkhand = require(".././assets/img/jharkhand.png");
export const health = require(".././assets/img/health.png");
export const welcome_img = require(".././assets/img/welcome_img.png");
export const splash_gif = require(".././assets/img/splash_gif.gif");
...
export const welcome = require(".././assets/json/welcome.json");
...
export const menus = [
  {
    menu_name: strings.government_message,
    icon: 'file-text-o',
    route:'GovernmentMessage'
  },
    {
    ...
    {
      menu_name: strings.vehicle_check_list,
      icon: 'car',
      route:'VehicleCheckList'
    },
    {
