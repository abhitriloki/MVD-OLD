...
import GovernmentMessage from './src/views/GovernmentMessage'; 
import CreateAmenities from './src/views/CreateAmenities'; 
import strings from './src/languages/strings';
import VehicleCheckList from './src/views/VehicleCheckList'; 

const TabArr = [
  { route: 'Dashboard', label:[strings.home], type: Icons.FontAwesome, icon: 'car', component: Dashboard, color: colors.theme_fg, alphaClr: colors.theme_bg_three },
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Welcome" screenOptions={({ route, navigation }) => ({
        ...
        <Stack.Screen name="GovernmentMessage" component={GovernmentMessage} options={{headerShown: false}} /> 
        <Stack.Screen name="CreateAmenities" component={CreateAmenities} options={{headerShown: false}} /> 
        <Stack.Screen name="VehicleCheckList" component={VehicleCheckList} options={{headerShown: false}} /> 
